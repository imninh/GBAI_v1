...
function vehicleIcon(heading: number | null | undefined) {
...
export default function LiveTracking({ routeId }: { routeId: number }) {
  ...
  useEffect(() => {
    ...
    fetchLatest();
    // Polling định kỳ mỗi 2 giây đảm bảo xe luôn di chuyển ngay cả khi WebSocket ngắt
    const pollTimer = setInterval(fetchLatest, 2000);
